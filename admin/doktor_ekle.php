...
<body>
    <div class="container">
        ...
        <div class="form-container" style="margin-top:40px;">
            ...
            <ul>
                <?php
                $doktorlar = $pdo->query("SELECT ad, soyad FROM doktorlar ORDER BY ad, soyad")->fetchAll();
                if ($doktorlar) {
                    foreach ($doktorlar as $doktor) {
                        echo "<li>Dr. " . htmlspecialchars($doktor['ad']) . " " . htmlspecialchars($doktor['soyad']) . "</li>";
                    }
                } else {
                    echo "<li>Henüz doktor kaydı yok.</li>";
                }
                ?>
            </ul>
        </div>
